 ...
 * introduzca datos no válidos. Tambi�n incluye un par de métodos para
...
public class ES {
    ...
    public static String obtenerNumeros(String mensaje) {
        String numero = "";
        boolean leido = false;
        Scanner teclado = null;
        do {
            ...
            try {
                ...
                String[] numerosSeparados = input.split(" ");
                for (int i = 0; i < numerosSeparados.length; i++) {
                    numero = numerosSeparados[i];
                }
     ...
     * Este método sirve para escribir el mensaje indicado para solicitar la
     * introducción de un dato desde teclado, y espera la introducción de
     * cualquier número decimal en el rango de números del tipo float, que será
     * el dato leído. La lectura se estará repitiendo hasta que el valor
     * suministrado está en ese rango.
     *
     * @param mensaje Es el mensaje que se muestra para solicitar la
     * introducción del número.
     * @return El número entero leído.
     */
    public static float leeDecimal(String mensaje) {
        float numero = 0f;
        boolean leido = false;
        Scanner teclado = null;
        do {
    ...
    /**
     * Método que valida una fechga en base a un formato
     */
