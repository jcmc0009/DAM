...
/**
 * Clase que representa una <strong>receta</strong> para la gestión de un
 * recetario.
 * <p>
 * Los objetos de esta clase permiten almacenar y gestionar información sobre la
 * propia receta: nombre, tipo de plato, lista de ingredientes, instrucciones y
 * fecha de creación.</p>
 *
 * @author profe
 */
public class Receta {
    ...
    public String getInstrucciones() {
        ...
        // Devolvemos una copia de la lista para evitar modificaciones externas
        String prueba = this.instrucciones;
        String salida = "";
        int contador = 1;
